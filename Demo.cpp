...
int main()
{
    ...
    vector<TerrainType> places = {MOUNTAIN, PASTURE};
    ...
    vector<TerrainType> places = {FOREST, PASTURE};
    ...
    vector<TerrainType> places = {FIELD, PASTURE};
    ...
    p1.placeRoad({FOREST, HILL}, {5, 6}, board); // p1 continues to build a road.
